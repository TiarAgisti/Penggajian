...
<a href="#" style="text-decoration:none"><?php if($flag == 'add'){ echo "Tambah Data Pendidikan";}else{echo "Edit Data Pendidikan";};?></a></div>
					...
					<a href="<?php echo base_url();?>pendidikan/pendidikan_list"  class="btn btn-default">Batal</a>
				    </div>
