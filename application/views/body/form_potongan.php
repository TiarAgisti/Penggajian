...
<a href="#" style="text-decoration:none"><?php if($flag == 'add'){ echo "Tambah Data Potongan";}else{echo "Edit Data Potongan";};?></a></div>
					...
					<a href="<?php echo base_url();?>potongan/potongan_list"  class="btn btn-default">Batal</a>
				    </div>
