...
<a href="#" style="text-decoration:none"><?php if($flag == 'add'){ echo "Tambah Data Tunjangan";}else{echo "Edit Data Tunjangan";};?></a></div>
					...
					<a href="<?php echo base_url();?>tunjangan/tunjangan_list"  class="btn btn-default">Batal</a>
				    </div>
