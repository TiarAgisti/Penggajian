...
<a href="#" style="text-decoration:none"><?php if($flag == 'add'){ echo "Tambah Data Golongan";}else{echo "Edit Data Golongan";};?></a></div>
					...
					<a href="<?php echo base_url();?>golongan/golongan_list"  class="btn btn-default">Batal</a>
				    </div>
